...
flow.
**State: PARTIAL.** Two-gauge estimate 3.44 m s^-1 sits at the upper edge and
is poorly constrained by daily data. Both SWOT estimators return 0.02-0.9 m
s^-1, violating this prior; they are reported as failures, not results.
...
**State: ENFORCED.** 21 lagged correlations tested between Kobuk stage and
chlorophyll; Bonferroni alpha = 0.00238; **zero survive**. No river-to-bloom
